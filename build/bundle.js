...
/***/ (function(module, exports) {
	...
	var createNode = function createNode(el) {
	    ...
	    if (!sInput.value) {
	        ...
	        fetch(url).then(function (resp) {
	            ...
	            return photos.map(function (photo) {
	                ...
	                var exifHref = "https://api.flickr.com/services/rest/?method=flickr.photos.getExif&api_key=1822a31c5cd782229698ed02217c7ea0&photo_id=" + photo.id;
	                exif.href = exifHref;
	...
	var openPhoto = function openPhoto() {
